               ...
               <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="have a beautiful view" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              ...
              <div className="flex flex-row gap-6">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" min={0} placeholder="Double Room" {...field} />
                    </FormControl>
                    <FormDescription>Provide your hotel name</FormDescription>
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" min={0} max={8} placeholder="Double Room" {...field} />
                    </FormControl>
                    <FormDescription>How many beds are available in the room?</FormDescription>
                  </FormItem>
                )}
              />
                <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" min={0} max={10} placeholder="Double Room" {...field} />
                    </FormControl>
              ...
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>How many bathroom  in the room</FormDescription>
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Break Fast Price</FormLabel>
                    <FormControl>
                      <Input type="number" min={0} placeholder="Double Room" {...field} />
                    </FormControl>
              ...
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>How many King beds available in this room</FormDescription>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>How many queen beds available in this room</FormDescription>
                  </FormItem>
                )}
              />
                </div>
