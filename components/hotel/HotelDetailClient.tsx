...
const HotelDetailClient = ({
  ...
  return (
    <div className="flex flex-col gap-6 pb-2">
      <div className="aspect-square overflow-hidden relative w-full  h-[200px] md:[400px] rounded-lg">
        <Image
          fill
          src={hotel.image}
          alt={hotel.title}
      ...
      <div>
        ...
        <h3 className="text-semibold text-lg mt-4 mb-2">Popular Amenities</h3>
